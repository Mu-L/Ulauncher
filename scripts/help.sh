...
The commands below are useful for maintainers:
  ...
  ${bold}./ul tag-release
    ${dim}Wrapper command to tag new releases and updating the version in setup.cfg${normal}
  ...
  ${bold}./ul build-release
    ${dim}Run from within Travis CI to build and upload the release${normal}
